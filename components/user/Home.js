...
// map review.type -> URL path segment
const TYPE_PATHS = {
  blog: 'blogs',
  movie: 'movies',
  book: 'books',
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="text-center py-24 relative overflow-hidden">
        ...
        {/* CTA Button (Get In Touch only, centered) */}
        <div className="flex items-center justify-center animate-in fade-in-0 zoom-in-95 duration-1000 delay-200">
          <Button
      ...
      {/* Recent Reviews Section (with horizontal padding) */}
      <div className="mt-16 relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        {/* Section Header */}
