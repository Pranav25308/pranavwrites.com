...
import { Eye, Activity, Users, Settings, LogOut, Moon, Sun, ArrowLeft, LayoutDashboard } from 'lucide-react';
...
export default function AdminLayout({ children }) {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      const isLoggedIn = token === 'admin-token-123';
  ...
  // Logged in - show admin nav and content
  return (
    <>
      <nav 
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link href="/" className="text-slate-300 hover:text-white transition-colors" title="Back to Site">
